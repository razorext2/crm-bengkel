    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <section class="rounded-lg bg-white p-8 antialiased shadow lg:p-16 dark:bg-gray-900">
            <form wire:submit.prevent="processToCheckout" class="mx-auto w-full px-4 2xl:px-0">
                ...
                <div class="space-y-4 border-b border-gray-200 pb-6 dark:border-gray-700">
                ...
                <div class="mt-6">
                    <div class="relative overflow-x-auto border-b border-gray-200 pb-6 dark:border-gray-800">
                        <table class="w-full text-left font-medium text-gray-900 md:table-fixed dark:text-white">
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                                ...
                                @forelse ($cartItems as $item)
                                    ...
                                    @endphp
                                    <tr>
                                        <td class="whitespace-nowrap md:w-[384px]">
                                        ...
                                        <td
                                            class="mt-2 flex items-center justify-center gap-x-2 text-base font-normal text-gray-900 dark:text-white">
                                        ...
                                        <td class="text-right text-base font-bold text-gray-900 dark:text-white">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <p class="me-2">
                                Gunakan <span
                                    class="font-semibold text-green-500">{{ auth()->user()->profile->points }}</span>
                                poin
                                untuk potongan?
                            </p>
                        </div>
                        ...
                        <label class="inline-flex cursor-pointer items-center">
                            <input type="checkbox" wire:model.live="usePoints" class="peer sr-only">
                            <div
                        ...
                        <div class="space-y-4">
                            ...
                            <dl
                                ...
                                <dd class="text-lg font-bold text-gray-900 dark:text-white">
                                    Rp.
                                    {{ number_format($usePoints ? $totalPrice - $pointsUsed : $totalPrice, 2, ',', '.') }}
                                </dd>
                            </dl>
                        </div>

<div class="mx-auto max-w-screen-xl p-4 lg:p-8">
    ...
    <section class="rounded-lg bg-white p-8 antialiased shadow-lg lg:p-16 dark:bg-gray-900">

        <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div class="flex flex-col gap-2 lg:gap-4">
                <div class="shrink-0">
                    <img class="w-full rounded-lg" src="{{ asset('storage/' . $product->product_image_primary) }}"
                        alt="Oli MPX">
                </div>

                <div class="flex w-full gap-x-2">
                    @foreach ($product->product_images as $image)
                        <img class="h-16 w-16 rounded-lg border border-gray-100 object-cover p-2"
                            src="{{ asset('storage/' . $image['url']) }}" alt="Oli MPX">
                    @endforeach
                </div>
            </div>
        ...
        <div class="flow-root py-8 lg:py-16">
            <h3 class="text-lg font-semibold">Ulasan Produk:</h3>
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @empty
                    <p class="mt-4 text-center text-sm italic text-gray-800 lg:mt-8">Belum Ada Ulasan</p>
                @endforelse
            </div>
        </div>

...
<div class="w-full p-4 lg:p-8">
    <nav class="mx-auto mb-2 mb-4 flex max-w-screen-xl py-4" aria-label="Breadcrumb">
    ...
    <section class="mx-auto max-w-screen-xl rounded-lg bg-white py-8 antialiased shadow-lg md:py-16 dark:bg-gray-900">
        <div class="mx-auto px-4">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                <div class="mx-auto max-w-md shrink-0 lg:max-w-lg">
                    <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                        src="https://www.hondacengkareng.com/wp-content/uploads/2021/04/Oli-MPX2.jpg" alt="Oli MPX">
                </div>
                ...
                <div class="mt-6 rounded-lg bg-gray-100 p-4 sm:mt-8 lg:mt-0 lg:p-8">
                    ...
                    <p class="mt-6 flex text-blue-700">
                        <svg class="me-2 h-6 w-6 text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="mt-6 flow-root sm:mt-8">
                        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                            <div class="grid gap-4 pb-4 md:grid-cols-12 md:gap-6 md:pb-6">
                                ...
                                <dl class="order-4 md:order-2 md:col-span-6">
                                    ...
                                    <dd class="text-gray-500 dark:text-gray-400">It’s fancy, amazing keyboard, matching
                                        accessories. Super fast, batteries last more than usual, everything runs perfect
                                        in this...</dd>
                                </dl>
                            ...
                            <div class="grid gap-4 py-4 md:grid-cols-12 md:gap-6 md:py-6">
                                ...
                                <dl class="order-4 md:order-2 md:col-span-6">
                                    <dt class="sr-only">Message:</dt>
                                    <dd class="text-gray-500 dark:text-gray-400">Elegant look, exceptional keyboard,
                                        and well-matched accessories. Lightning-quick speed, impressive battery
                                        duration...</dd>
                                </dl>
                            ...
                            <div class="grid gap-4 py-4 md:grid-cols-12 md:gap-6 md:py-6">
                                <dl class="order-3 md:order-1 md:col-span-3">
                                    <dt class="sr-only">Product:</dt>
                                    <dd class="text-base font-semibold text-gray-900 dark:text-white">
                                        <a href="#" class="hover:underline">Apple Watch SE [GPS 40mm],
                                            Smartwatch </a>
                                    </dd>
                                </dl>
                            ...
                            <div class="grid gap-4 py-4 md:grid-cols-12 md:gap-6 md:py-6">
                                <dl class="order-3 md:order-1 md:col-span-3">
                                    <dt class="sr-only">Product:</dt>
                                    <dd class="text-base font-semibold text-gray-900 dark:text-white">
                                        <a href="#" class="hover:underline">Apple MacBook PRO Laptop with M2
                                            chip </a>
                                    </dd>
                                </dl>
                                ...
                                <dl class="order-4 md:order-2 md:col-span-6">
                                    ...
                                    <dd class="text-gray-500 dark:text-gray-400">Elegant and refined, with well-chosen
                                        accessories. Quick response, durable battery, and everything runs smoothly...
                                    </dd>
                                </dl>
                            ...
                            <div class="grid gap-4 py-4 md:grid-cols-12 md:gap-6 md:py-6">
                                ...
                                <dl class="order-4 md:order-2 md:col-span-6">
                                    <dt class="sr-only">Message:</dt>
                                    <dd class="text-gray-500 dark:text-gray-400">The console's design might not appeal
                                        to everyone, and exclusive titles are still somewhat limited...</dd>
                                </dl>
                            ...
                            <div class="grid gap-4 py-4 md:grid-cols-12 md:gap-6 md:py-6">
                                <dl class="order-3 md:order-1 md:col-span-3">
                                    <dt class="sr-only">Product:</dt>
                                    <dd class="text-base font-semibold text-gray-900 dark:text-white">
                                        <a href="#" class="hover:underline">Microsoft Surface Pro, Copilot+ PC,
                                            13 Inch </a>
                                    </dd>
                                </dl>
                            ...
                            <div class="grid gap-4 pt-4 md:grid-cols-12 md:gap-6 md:pt-6">
                                <dl class="order-3 md:order-1 md:col-span-3">
                                    <dt class="sr-only">Product:</dt>
                                    <dd class="text-base font-semibold text-gray-900 dark:text-white">
        ...
        <div id="deleteReviewModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative h-full w-full max-w-md p-4 md:h-auto">
                <!-- Modal content -->
                <div class="relative rounded-lg bg-white p-4 text-center shadow sm:p-5 dark:bg-gray-800">
                    <button type="button"
        ...
        <div id="editReviewModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative max-h-full w-full max-w-2xl p-4">
                ...
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                    <!-- Modal header -->
                    <div
                        class="flex items-center justify-between rounded-t border-b border-gray-200 p-4 md:p-5 dark:border-gray-700">
                        ...
                        <div class="mb-4 grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="ms-2 text-lg font-bold text-gray-900 dark:text-white">3.0 out of
                                        5</span>
                                </div>
                            </div>
                            <div class="col-span-2">

        ...
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-2 flex items-center text-sm text-gray-500 sm:text-base dark:text-gray-400">
                    ...
                    <div class="space-y-4">
                        ...
                        <dl>
                            ...
                            <dd class="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                                <svg class="hidden h-5 w-5 shrink-0 text-gray-400 lg:inline dark:text-gray-500"
            ...
            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 md:p-8 dark:border-gray-700 dark:bg-gray-800">
                <h3 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Latest orders</h3>
                <div
                    class="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4 md:pb-5 dark:border-gray-700">
                    ...
                    <div class="w-full sm:flex sm:w-32 sm:items-center sm:justify-end sm:gap-4">
                        <button id="actionsMenuDropdownModal10" data-dropdown-toggle="dropdownOrderModal10"
                            type="button"
                            class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 md:w-auto dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
                            Actions
                ...
                <div
                    class="flex flex-wrap items-center gap-y-4 border-b border-gray-200 py-4 pb-4 md:py-5 dark:border-gray-700">
                    <dl class="w-1/2 sm:w-48">
                        <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Order ID:</dt>
                        <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">
                ...
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                    ...
                    <form class="p-4 md:p-5">
                        ...
                        <div class="border-t border-gray-200 pt-4 md:pt-5 dark:border-gray-700">
                            <button type="submit"
                                class="me-2 inline-flex items-center rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save
                                information</button>
            ...
            <div class="relative h-full w-full max-w-md p-4 md:h-auto">
                ...
                <div class="relative rounded-lg bg-white p-4 text-center shadow sm:p-5 dark:bg-gray-800">
                    ...
                    <p class="mb-3.5 text-gray-900 dark:text-white"><a href="#"
                            class="font-medium text-blue-700 hover:underline dark:text-blue-500">@heleneeng</a>,
                        are
